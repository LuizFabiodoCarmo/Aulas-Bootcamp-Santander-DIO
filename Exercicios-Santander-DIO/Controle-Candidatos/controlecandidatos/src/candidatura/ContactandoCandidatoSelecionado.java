...
public class ContactandoCandidatoSelecionado {
	...
	static void entrandoEmContato(String candidato) {
		...
		if(atendeu)
			...
			System.out.println("NÃO CONSEGUIMOS CONTATO COM: " +candidato+ " NÚMERO MÁXIMO DE LIGAÇÕES " +tentativasRealizadas+ " REALIZADA");
	}
